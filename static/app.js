  ...
  return `<div class="integration-card ${configured?'connected':''}">
    <div class="integration-card-header">
      ...
      <div class="integration-info">
        ...
        <div class="integration-desc">Contacts, accounts, and opportunity data via SSO</div>
      </div>
      ${statusHtml}
    </div>
    <div class="integration-body">${bodyHtml}</div>
...
function renderWizardStep() {
  ...
  const steps = {
    ...
    salesforce: {
      ...
      sub:   "Connect via OAuth SSO — no password needed. Requires a Salesforce Connected App.",
